...
yystate(15, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 122 ->
    yystate(15, Ics, Line, Tlen+1, 4, Tlen);
yystate(15, [C|Ics], Line, Tlen, _, _) when C >= 124 ->
    yystate(15, Ics, Line, Tlen+1, 4, Tlen);
...
yystate(14, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 122 ->
    yystate(15, Ics, Line, Tlen+1, Action, Alen);
...
yystate(13, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 122 ->
    yystate(13, Ics, Line, Tlen+1, 3, Tlen);
...
yystate(12, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(13, Ics, Line, Tlen+1, 3, Tlen);
yystate(12, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 122 ->
    yystate(13, Ics, Line, Tlen+1, 3, Tlen);
...
yystate(10, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(11, Ics, Line, Tlen+1, Action, Alen);
yystate(10, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 34 ->
    yystate(11, Ics, Line, Tlen+1, Action, Alen);
yystate(10, [C|Ics], Line, Tlen, Action, Alen) when C >= 36, C =< 46 ->
    yystate(11, Ics, Line, Tlen+1, Action, Alen);
yystate(10, [C|Ics], Line, Tlen, Action, Alen) when C >= 48, C =< 124 ->
    yystate(11, Ics, Line, Tlen+1, Action, Alen);
...
yystate(8, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 124 ->
    yystate(2, Ics, Line, Tlen+1, Action, Alen);
...
yystate(3, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(5, Ics, Line, Tlen+1, Action, Alen);
yystate(3, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 124 ->
    yystate(5, Ics, Line, Tlen+1, Action, Alen);
